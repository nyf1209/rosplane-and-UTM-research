...
if("TRUE" STREQUAL "TRUE")
  set(rosflight_firmware_SOURCE_PREFIX /home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware)
  set(rosflight_firmware_DEVEL_PREFIX /home/yifengn2/catkin_ws3/devel)
  ...
  set(rosflight_firmware_INSTALL_PREFIX /home/yifengn2/catkin_ws3/install)
...
if(NOT "/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/include;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/include/;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/lib/;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/comms/;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/test/ " STREQUAL " ")
  set(rosflight_firmware_INCLUDE_DIRS "")
  set(_include_dirs "/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/include;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/include/;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/lib/;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/comms/;/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/firmware/test/")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosflight_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yifengn2/catkin_ws3/src/rosflight/rosflight_firmware/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosflight_firmware_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosflight_firmware;rosflight_udp_board;rosflight_test")
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosflight_firmware_NUM_DUMMY_TARGETS)
      set(rosflight_firmware_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosflight_firmware::wrapped-linker-option${rosflight_firmware_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosflight_firmware_NUM_DUMMY_TARGETS "${rosflight_firmware_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosflight_firmware::wrapped-linker-option${rosflight_firmware_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosflight_firmware_LIBRARIES "${interface_target_name}")
