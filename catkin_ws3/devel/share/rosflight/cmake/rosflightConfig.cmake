...
if("TRUE" STREQUAL "TRUE")
  set(rosflight_SOURCE_PREFIX /home/yifengn2/catkin_ws3/src/rosflight/rosflight)
  set(rosflight_DEVEL_PREFIX /home/yifengn2/catkin_ws3/devel)
  ...
  set(rosflight_INSTALL_PREFIX /home/yifengn2/catkin_ws3/install)
...
if(NOT "/home/yifengn2/catkin_ws3/src/rosflight/rosflight/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(rosflight_INCLUDE_DIRS "")
  set(_include_dirs "/home/yifengn2/catkin_ws3/src/rosflight/rosflight/include;/usr/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosflight' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yifengn2/catkin_ws3/src/rosflight/rosflight/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT rosflight_NUM_DUMMY_TARGETS)
      set(rosflight_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosflight::wrapped-linker-option${rosflight_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosflight_NUM_DUMMY_TARGETS "${rosflight_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosflight::wrapped-linker-option${rosflight_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosflight_LIBRARIES "${interface_target_name}")
...
set(depends "roscpp;eigen_stl_containers;geometry_msgs;rosflight_msgs;sensor_msgs;std_msgs;tf;tf")
