...
get_filename_component(_filename "/home/yifengn2/catkin_ws3/src/hector_gazebo/hector_gazebo_plugins/srv/SetBias.srv" NAME_WE)
add_custom_target(_hector_gazebo_plugins_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hector_gazebo_plugins" "/home/yifengn2/catkin_ws3/src/hector_gazebo/hector_gazebo_plugins/srv/SetBias.srv" "geometry_msgs/Vector3"
)
...
_generate_srv_cpp(hector_gazebo_plugins
  "/home/yifengn2/catkin_ws3/src/hector_gazebo/hector_gazebo_plugins/srv/SetBias.srv"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hector_gazebo_plugins)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3.5\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/hector_gazebo_plugins\")")
  # install generated code
  install(
